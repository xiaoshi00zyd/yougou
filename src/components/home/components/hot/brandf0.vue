...
export default {
  ...
  async created () {
    ...
    this.banner = this.testList[0].down[this.$route.query.id].Child.banner
    // console.log(this.testList[0].clearSale[this.$route.query.id].Child.banner)
    this.age = this.$route.query.id
    if (!this.$route.query.id) {
      this.num = this.testList[0].down[this.age]
      this.obj = this.testList[0].down[this.age].Child.data
    } else {
      this.num = this.testList[0].down[this.$route.query.id]
      this.obj = this.testList[0].down[this.$route.query.id].Child.data
    }
