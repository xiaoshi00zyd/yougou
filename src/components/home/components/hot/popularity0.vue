...
export default {
  ...
  async created () {
    this.testList = await getClassification()
    console.log(this.testList[0].down)
    this.banner = this.testList[0].up[this.$route.query.id].Child.banner
    // console.log(this.testList[0].clearSale[this.$route.query.id].Child.banner)
    this.age = this.$route.query.id
    if (!this.$route.query.id) {
      this.num = this.testList[0].up[this.age]
      this.obj = this.testList[0].up[this.age].Child.data
    } else {
      this.num = this.testList[0].up[this.$route.query.id]
      this.obj = this.testList[0].up[this.$route.query.id].Child.data
    }
