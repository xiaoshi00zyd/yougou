...
export default {
  ...
  async created () {
    ...
    this.testList = await getActivity()
    console.log(this.testList[0].list[this.$route.query.id])
    this.age = this.$route.query.id
    if (!this.$route.query.id) {
      this.num = this.testList[0].list[this.age]
      this.obj = this.testList[0].list[this.age].Child.data
    } else {
      this.num = this.testList[0].list[this.$route.query.id]
      this.obj = this.testList[0].list[this.$route.query.id].Child.data
    }
